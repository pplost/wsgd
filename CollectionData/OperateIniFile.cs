...
namespace CollectionData
{
     ...
     */
        ...
        public static string[] INIGetAllSectionNames(string iniFile)
        {
            ...
            uint bytesReturned = OperateIniFile.GetPrivateProfileSectionNames(pReturnedString, MAX_BUFFER, iniFile);
            if (bytesReturned != 0)
            {
                //读取指定内存的内容  
        ...
        public static string[] INIGetAllItems(string iniFile, string section)
        {
            ...
            uint bytesReturned = OperateIniFile.GetPrivateProfileSection(section, pReturnedString, MAX_BUFFER, iniFile);
        ...
        public static string[] INIGetAllItemKeys(string iniFile, string section)
        {
            ...
            uint bytesReturned = OperateIniFile.GetPrivateProfileString(section, null, null, chars, SIZE, iniFile);
        ...
        public static string iniGetStringValue(string iniFile, string section, string key, string defaultValue)
        {
            ...
            uint bytesReturned = OperateIniFile.GetPrivateProfileString(section, key, defaultValue, sb, SIZE, iniFile);
        ...
        public static bool iniWriteItems(string iniFile, string section, string items)
        {
            ...
            return OperateIniFile.WritePrivateProfileSection(section, items, iniFile);
        }
        ...
        public static bool iniWriteValue(string iniFile, string section, string key, string value)
        {
            ...
            return OperateIniFile.WritePrivateProfileString(section, key, value, iniFile);
        ...
        public static bool iniDeleteKey(string iniFile, string section, string key)
        {
            ...
            return OperateIniFile.WritePrivateProfileString(section, key, null, iniFile);
        }
        ...
        public static bool iniDeleteSection(string iniFile, string section)
        {
            ...
            return OperateIniFile.WritePrivateProfileString(section, null, null, iniFile);
        }
        ...
        public static bool iniEmptySection(string iniFile, string section)
        {
            ...
            return OperateIniFile.WritePrivateProfileSection(section, string.Empty, iniFile);
        }
